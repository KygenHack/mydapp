...
you've come to the right place.
 ...
 style={{ opacity: 1, transform: "none" }}>
    <img src="https://tbcrewardcoin.online/assets/trcfrontend/images/favicon.png" alt="INTDESTCOIN Operate" className="w-16 h-16" />
  ...
  <div className="flex items-start gap-12 hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]" style={{ opacity: 1, transform: "none" }}>
    <img src="https://tbcrewardcoin.online/assets/trcfrontend/images/favicon.png" alt="XCHAIN a vision of Infinity" className="w-16 h-16" />
    <div className="flex flex-col">
  ...
  <div className="flex items-start gap-12 hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]" style={{ opacity: 1, transform: "none" }}>
    <img src="https://tbcrewardcoin.online/assets/trcfrontend/images/favicon.png" alt="INTDESTCOIN subprojects" className="w-16 h-16" />
    <div className="flex flex-col">
  ...
  <div className="flex items-start gap-12 hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]" style={{ opacity: 1, transform: "none" }}>
    <img src="https://tbcrewardcoin.online/assets/trcfrontend/images/favicon.png" alt="INTDEST Ai (INTAI)" className="w-16 h-16" />
    <div className="flex flex-col">
